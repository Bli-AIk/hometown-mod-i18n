...
kris:setFacing("left")
    ...
    cutscene:attachCamera(1)
    cutscene:wait(1)
    cutscene:text("* Who is that?", "surprise_confused", "ralsei")
    ...
    cutscene:wait(0.5)
    Game.world.music:play("d", 0)
    ralsei:shake(2)
    Assets.playSound("wing")
    ralsei:resetSprite()
    ralsei:setFacing("left")
    cutscene:wait(0.3)
    cutscene:text("*[noskip] W[wait:2]-why are they\nattacking me?", "concern_smile", "ralsei")
    ralsei:walkTo(ralsei.x - 600, ralsei.y, 3)
    cutscene:wait(2)
    cutscene:detachCamera() 
    cutscene:wait(1)
    Game.world.music:fade(0.5, 2.5)
    ...
    cutscene:text("* [color:yellow]TENSION[color:reset] is high!")
    effect:remove()
    cutscene:wait(1)
