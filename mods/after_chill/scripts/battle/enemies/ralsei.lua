...
function ralsei:onDefeat()
   if self:getFlag("dead") then 
        Game.battle:startCutscene(function(cutscene)
            ...
            cutscene:text("* Yet,[wait:5] the life I got to live,[wait:2] the memories I made.[wait:2].[wait:2].[wait:2]", "disappointed_smile", "ralsei")
            ...
            cutscene:text("* I would choose to be meet you guys again,[wait:2] in every single one of them.", "pleading_closed", "ralsei")
            self:shake(2)
