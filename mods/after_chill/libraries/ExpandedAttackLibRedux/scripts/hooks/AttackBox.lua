...
function AttackBox:init(battler, offset, index, x, y)
    ...
    self.weapon = battler.chara:getWeapon() or Mod.libs["ExpandedAttackLib"].fallback_weapon
...
function AttackBox:hit()
    ...
    local equip = self.battler.chara:getWeapon() or Mod.libs["ExpandedAttackLib"].fallback_weapon
