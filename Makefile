...
build-love:
	HOMETOWN_MOD_I18N_BUILD_LOVE=1 HOMETOWN_MOD_I18N_BUILD_WINDOWS_EXE=0 ./tools/build_standalone.sh

build-win:
	HOMETOWN_MOD_I18N_BUILD_LOVE=0 HOMETOWN_MOD_I18N_BUILD_WINDOWS_EXE=1 ./tools/build_standalone.sh

build:
	HOMETOWN_MOD_I18N_BUILD_LOVE=1 HOMETOWN_MOD_I18N_BUILD_WINDOWS_EXE=1 ./tools/build_standalone.sh
