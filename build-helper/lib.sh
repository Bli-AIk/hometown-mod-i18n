...
# ensure_java downloads a portable Temurin JDK 17 into $HOMETOWN_MOD_I18N_TOOLS_DIR/jdk17
...
HOMETOWN_MOD_I18N_JDK_DIR="${HOMETOWN_MOD_I18N_JDK_DIR:-$HOMETOWN_MOD_I18N_TOOLS_DIR/jdk17}"
