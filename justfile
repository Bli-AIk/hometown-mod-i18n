...
# (local / path / tag / commit / branch); set HOMETOWN_MOD_I18N_KRISTAL_SOURCE=… to skip.
# zh_hans: 编译构建 Android APK（完整构建，需要 JDK 17 + Android SDK API 34 + NDK 25.2.9519653；缺 JDK/SDK 时首次自动下载到 Kristal 根 .tools/jdk17 / .tools/android-sdk，无引擎时回退 mod 根 .tools；交互运行时与 build 一样询问 Kristal 引擎来源（本地/路径/tag/commit/分支），设 HOMETOWN_MOD_I18N_KRISTAL_SOURCE=… 可跳过）
build-android:
