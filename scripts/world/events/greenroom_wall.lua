...
function GreenRoomWall:init(data)
	...
	self.scale = 2
	self.texture = Assets.getTexture('world/castle_town/tv/star_tile')
	self.tex_width = self.texture:getWidth() * self.scale
	self.tex_height = self.texture:getHeight() * self.scale + 5
    self.vine_texture = Assets.getTexture('world/castle_town/tv/green_room_vines')
    self.shine_frames = Assets.getFrames('world/castle_town/tv/shine_white')
