...
"""
    replacement = """    def signingKeystore = System.getenv("HOMETOWN_PACK_ANDROID_SIGNING_KEYSTORE")
    def hasCustomSigning = signingKeystore != null && !signingKeystore.isEmpty()
    def signingStorePassword = System.getenv("HOMETOWN_PACK_ANDROID_SIGNING_STORE_PASSWORD")
    def signingKeyAlias = System.getenv("HOMETOWN_PACK_ANDROID_SIGNING_KEY_ALIAS")
    def signingKeyPassword = System.getenv("HOMETOWN_PACK_ANDROID_SIGNING_KEY_PASSWORD")
