...
HOMETOWN_MOD_I18N_KRISTAL_REF="${HOMETOWN_MOD_I18N_KRISTAL_REF:-8e592d84065263138d4e92593f0a4ab780d93822}"
...
choose_kristal_source() {
    ...
    if [ -z "$HOMETOWN_MOD_I18N_KRISTAL_EXPECTED_VERSION_ENV" ] \
        ...
        case "$HOMETOWN_MOD_I18N_KRISTAL_SOURCE:$HOMETOWN_MOD_I18N_KRISTAL_REF" in
            commit:8e592d84065263138d4e92593f0a4ab780d93822) HOMETOWN_MOD_I18N_KRISTAL_VERIFY_VERSION=1 ;;
...
resolve_kristal_source() {
    ...
    if [ -n "$HOMETOWN_MOD_I18N_KRISTAL_REF_ENV" ] \
        && [ "$HOMETOWN_MOD_I18N_KRISTAL_REF_ENV" != "8e592d84065263138d4e92593f0a4ab780d93822" ]; then
